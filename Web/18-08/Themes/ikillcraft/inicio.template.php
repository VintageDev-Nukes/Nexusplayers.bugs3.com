...
<table style="
    position: relative;
    top: -2px;
"><tbody><tr><td><br><h2 style="padding-bottom:10px;">NexusPlayers! Chat:</h2><script id="sid0020000037900386993">(function() {function async_load(){s.id="cid0020000037900386993";s.src=\'http://st.chatango.com/js/gz/emb.js\';s.style.cssText="width:500px;height:500px;";s.async=true;s.text=\'{"handle":"nexusplayers","styles":{"a":"ffffff","b":100,"c":"000000","d":"000000","k":"ffffff","l":"ffffff","m":"ffffff","q":"ffffff","r":100,"usricon":0}}\';var ss = document.getElementsByTagName(\'script\');for (var i=0, l=ss.length; i < l; i++){if (ss[i].id==\'sid0020000037900386993\'){ss[i].id +=\'_\';ss[i].parentNode.insertBefore(s, ss[i]);break;}}}var s=document.createElement(\'script\');if (s.async==undefined){if (window.addEventListener) {addEventListener(\'load\',async_load,false);}else if (window.attachEvent) {attachEvent(\'onload\',async_load);}}else {async_load();}})();</script>
    ...
    padding-top: 5px;
"><i>Normas de la chat:</i></h3><br><span class="ShineStatus rojo"></span> No se permite el spam aqu&iacute;, <a href="http://'.$_SERVER['SERVER_NAME'].'/index.php?action=register" title="Registro">registrense en el foro</a> para ello. A parte, todos los links est&aacute;n censurados, as&iacute; que no se la jueguen.<br>
