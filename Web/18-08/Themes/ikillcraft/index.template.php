...
<script type="text/javascript" src="http://'.$_SERVER['SERVER_NAME'].'/Themes/ikillcraft/30877038380357.js"></script>
</td>
</tr>
<tr>
...
<div class="all2" style="margin: 0 auto;margin-bottom: 40px; width:' . $settings['forum_width'] . ';">' : '', '
	<div class="top">
<a href="http://'.$_SERVER['SERVER_NAME'].'/index.php?action=forum"><img src="http://nexusplayers.bugs3.com/NexusLogo.png" style="position:relative; top:50%; margin-top:-47px; left:20px;" /></a>
...
<div id="menop" onmouseover="muestra(\'header-messages-menu\');" onmouseout="ocultar(\'header-messages-menu\');" onclick="location.href=\'?action=pm\';">', $txt['pm_short'] ,''.if(!$user_info['unread_messages'] == 0) {echo '['.$user_info['unread_messages'].']'}.'</div>
