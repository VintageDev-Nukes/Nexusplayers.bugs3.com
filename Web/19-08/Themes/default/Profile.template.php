	...
	echo '
							<li>
								...
								<label for="view_newest_first"><input type="checkbox" name="default_options[view_newest_first]" id="view_newest_first" value="1"', !empty($context['member']['options']['view_newest_first']) ? ' checked="checked"' : '', ' class="input_check" /> ', $txt['recent_posts_at_top'], '</label>
										...
										<li>
												<input type="hidden" name="default_options[disable_iob]" value="0" />
												<label for="disable_iob"><input type="checkbox" name="default_options[disable_iob]" id="disable_iob" value="1"', !empty($context['member']['options']['disable_iob']) ? ' checked="checked"' : '', ' class="check" /> ', $txt['disable_iob'], '</label>
										</li>';
