...
function loadMemberContext($user, $display_custom_fields = false)
{
	...
	if($memberContext[$user]['avatar']['image'] == '' && !empty($modSettings['enable_default_avatar']) && ($memberContext[$user]['gender']['name'] == $txt['male']) && !empty($modSettings['default_male_avatar_url']))
		$memberContext[$user]['avatar'] = array(
			'name' => '',
			'image' => (($profile['is_online'] || empty($modSettings['default_avatar_opacity'])) ? '<img class="avatar" src="' . $modSettings['default_male_avatar_url'] . '" alt="" />' : '<img class="avatar" src="' . $modSettings['default_male_avatar_url'] . '" alt="" />'),
			'href' => '',
			'url' => '',
		);
